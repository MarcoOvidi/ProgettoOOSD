...
public class TranscriptionWorkProjectQuerySet {
	 ...
	 */
	public static TranscriptionWorkProject loadTranscriptionWorkProject(UUIDTranscriptionWorkProject id)
	 ...
	 */
	public static Boolean insertTranscriberUser(UUIDTranscriptionWorkProject ids, UUIDUser id)
			throws DatabaseException, NullPointerException {
		if (ids == null)
	 ...
	 * @throws NullPointerException in caso i parametri di input siano nulli
	 */
	public static Boolean insertReviserUser(UUIDUser id, UUIDTranscriptionWorkProject ids)
			throws DatabaseException, NullPointerException {
		if (ids == null)
			throw new NullPointerException("Id Progetto non valido");
	 ...
	 * @throws NullPointerException in caso i parametri di input siano nulli
	 */
	public static Boolean removeTranscriberUser(UUIDUser id, UUIDTranscriptionWorkProject ids)
			throws DatabaseException, NullPointerException {
		if (ids == null)
			throw new NullPointerException("Id Progetto non valido");
	 ...
	 * @throws NullPointerException in caso i parametri di input siano nulli
	 */
	public static Boolean removeReviserUser(UUIDUser id, UUIDTranscriptionWorkProject ids)
			throws DatabaseException, NullPointerException {
		if (ids == null)
			throw new NullPointerException("Id Progetto non valido");
	 ...
	 * @throws NullPointerException in caso i parametri di input siano nulli
	 */
	public static Integer insertTranscriberUser(LinkedList<UUIDUser> idl, UUIDTranscriptionWorkProject ids)
			throws DatabaseException, NullPointerException {
		if (idl == null)
	 ...
	 * @throws NullPointerException in caso i parametri di input siano nulli
	 */
	public static Integer insertReviserUser(LinkedList<UUIDUser> idl, UUIDTranscriptionWorkProject ids)
			throws DatabaseException, NullPointerException {
		if (idl == null)
			throw new NullPointerException("Lista di utenti non valida");
		if (ids == null)
	 ...
	 * @throws NullPointerException in caso i parametri di input siano nulli
	 */
	public static Integer removeTranscriberUser(LinkedList<UUIDUser> idl, UUIDTranscriptionWorkProject ids)
			throws DatabaseException, NullPointerException {
		if (idl == null)
			throw new NullPointerException("Lista di utenti non valida");
		if (ids == null)
	 ...
	 * @throws NullPointerException in caso i parametri di input siano nulli
	 */
	public static Integer removeReviserUser(LinkedList<UUIDUser> idl, UUIDTranscriptionWorkProject ids)
			throws DatabaseException, NullPointerException {
		if (idl == null)
			throw new NullPointerException("Lista di utenti non valida");
		if (ids == null)
	...
	public static Boolean deleteTranscriptionWorkProject(UUIDTranscriptionWorkProject id)
			throws DatabaseException, NullPointerException {
		if (id == null)
			throw new NullPointerException("Id non vallido");
	 ...
	 */
	public static HashMap<UUIDTranscriptionWorkProject, String[]> loadMyCoordinatedTranscriptionWorkProjectList(
	 ...
	 */
	public static Boolean changeTranscriptionProjectCoordinator(UUIDUser id, UUIDTranscriptionWorkProject ids)
			throws DatabaseException, NullPointerException {
		if (ids == null)
			throw new NullPointerException("Id Progetto non valido");
