...
public class DownloadController {
	...
	public static Document getOperaTranscription(model.Document doc, String destination) {
		...
		Paragraph footer = new Paragraph("BIBLIO SUITE - DOCUMENT: " + doc.getTitle().toUpperCase() + " PAGE 0/" + doc.getPagesNumber());
		...
		for(Page p : list) {
			...
			footer = new Paragraph("BIBLIO SUITE - DOCUMENT: " + doc.getTitle().toUpperCase() + " PAGE " + p.getPageNumber()+ "/" + doc.getPagesNumber());
			footer.setFontSize(11);
			footer.setFixedPosition(200, 10, 300);
			document.add(footer);	
		}
